...
interface Container {
     ...
     * acquire its dependencies), will instantiate the item of the supplied type.
     */
    fun <T: Any, Arg1: Any> register(scope: Scope, type: Class<T>, name: String? = null, factory: (Resolver, Arg1) -> T)
     ...
     * acquire its dependencies), will instantiate the item of the supplied type.
     */
    fun <T: Any, Arg1: Any, Arg2: Any> register(scope: Scope, type: Class<T>, name: String? = null, factory: (Resolver, Arg1, Arg2) -> T)
     ...
     * acquire its dependencies), will instantiate the item of the supplied type.
     */
    fun <T: Any, Arg1: Any, Arg2: Any, Arg3: Any> register(scope: Scope, type: Class<T>, name: String? = null, factory: (Resolver, Arg1, Arg2, Arg3) -> T)
}
